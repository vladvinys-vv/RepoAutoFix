...
class CodeLineNumberRenderObject extends RenderBox {
  ...
  final TextStyle Function(int lineIndex) _customLineIndex2TextStyle;
  ...
  CodeLineNumberRenderObject({
    ...
    String Function(int lineIndex)? customLineIndex2Text,
    required TextStyle Function(int lineIndex) customLineIndex2TextStyle,
  }) : _controller = controller,
       _notifier = notifier,
       _focusedTextStyle = focusedTextStyle,
       _minNumberCount = minNumberCount,
       _allLineCount = controller.lineCount,
       _customLineIndex2Text = customLineIndex2Text,
       _customLineIndex2TextStyle = customLineIndex2TextStyle,
  ...
  void performLayout() {
    ...
    _textPainter.text = TextSpan(text: '0' * max(_minNumberCount, _allLineCount.toString().length), style: _customLineIndex2TextStyle(0));
    _textPainter.layout();
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    for (final CodeLineRenderParagraph paragraph in value.paragraphs) {
      ...
      _textPainter.text = TextSpan(
        text: lineIndexText,
        style: paragraph.index == value.focusedIndex ? _focusedTextStyle : _customLineIndex2TextStyle(firstLineIndex),
      );
      _textPainter.layout();
...
class CodeChunkIndicatorRenderObject extends RenderBox implements MouseTrackerAnnotation {
  ...
  void performLayout() {
    assert(
      _width > 0 && _width != double.infinity && constraints.maxHeight > 0 && constraints.maxHeight != double.infinity,
